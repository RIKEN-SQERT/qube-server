...
class QSMessage:
    ...
    ERR_INVALID_WAVD_INCONSISTENT_CH_WF = (
        "Inconsistent number of waveforms: {} and channels: {}."
    )
    ERR_INVALID_WAVD_NOT_ALL_PORT_CHANNELS = (
        "Not all channels are in channels of the port."
    )
    ...
    ERR_INVALID_WAVD_MAGNITUDE = (
        "The absolute value of complex data is {}, should be less than 1."
    )
